      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-foreground-muted mt-1">
            Configure as preferências do Camoufox.
          </p>
        </div>
          ...
          <CardContent>
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <p className="text-sm text-foreground-muted text-center max-w-sm">
                Esta seção será implementada em breve. Aqui você poderá configurar preferências gerais, conexão com o backend do Camoufox, e muito mais.
              </p>
            </div>
          </CardContent>
        </Card>
